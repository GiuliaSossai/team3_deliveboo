    ...
    <div class="gs-box">
        <div class="container">
            ...
            <div class="orders my-4">
                ...
                <span><a class="gs-link mb-5" href="{{ route('admin.order.index', $restaurant->slug) }}">i tuoi
                        ordini</a></span>
                {{-- role="button" --}}
            </div>
            ...
            <div class="orders my-4">
                ...
                <span><a class="gs-link mb-5" href="{{ route('admin.ristoranti.index') }}">torna ai ristoranti</a></span>
                {{-- role="button" --}}
            </div>
            ...
            <div class="row">
                <div class="col">
                    <a class="gs-btn btn btn-primary px-3 mb-5"
                        href="{{ route('admin.piatti.create', $restaurant->slug) }}" role="button">Aggiungi un nuovo
                        piatto</a>
                </div>
            </div>
